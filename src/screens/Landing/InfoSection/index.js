...
const sectionOne = [
  {
    ...
    title: 'Green House',
    description:
      'A locker of all the plants a person is growing with data of the daily processes including time-lapse generators,',
  ...
  },
  {
    ...
    title: 'Contest',
    description:
      'Daily, weekly and monthly competitions will be help for growers of various categories.',
    imageUrl: contestImg,
  },
  {
    id: 3,
    ...
    description:
      'Ranking of the best growers in the world, who can help with the one on one consulting.',
    imageUrl: rankingImg,
  },
];
...
const sectionTwo = [
  {
    ...
    description:
      'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque, id ipsam. Quasi explicabo necessitatibus quas, neque id minus quibusdam itaque earum, placeat officiis ab corporis, consequuntur eius iste nulla illo',
    imageUrl: howToImg,
  },
  {
    id: 2,
